...
| 分类 | 事实片段 | 地址 | 占全部地址 | 含义 |
|---|---:|---:|---:|---|
| `operator_registration` | 13,383 | 15,306,570 | 95.7796% | 登记文本可归属于三网运营商 |
| `independent_legal_entity` | 42,095 | 275,724 | 1.7253% | 登记文本出现完整独立法定主体；仅作为复核线索 |
| `other_registration` | 61,276 | 398,745 | 2.4951% | 未归入前三类的 APNIC 登记 |
...
共 37,879 个登记主体标签；下表展示前 100 项。标签优先取 APNIC organisation name，其次取 description、netname 或 organisation handle。
...
| 5 | Giant Network Technology Co., Ltd. Hangzhou Chong | 1,408 | 0.0088% | 7 | `115.236.22.128–115.236.22.159` in `115.236.22.0/24`<br>`115.236.22.160–115.236.22.191` in `115.236.22.0/24`<br>`115.236.22.192–115.236.22.223` in `115.236.22.0/24` |
| 6 | WENZHOU GAOJIE TECHNOLOGY CO.LTD | 1,224 | 0.0077% | 30 | `60.190.168.128–60.190.168.191` in `60.190.160.0/19`<br>`60.190.172.0–60.190.172.31` in `60.190.160.0/19`<br>`60.190.172.80–60.190.172.95` in `60.190.160.0/19` |
| 7 | Hangzhou Tianjian Info-Technology Corp.,Ltd. | 1,024 | 0.0064% | 1 | `103.246.152.0–103.246.155.255` in `103.246.152.0/22` |
| 8 | Hangzhou international Cci Capital Ltd | 772 | 0.0048% | 92 | `60.190.239.136–60.190.239.143` in `60.190.236.0/22`<br>`60.191.21.112–60.191.21.127` in `60.191.21.64/26`<br>`60.191.23.64–60.191.23.67` in `60.191.22.0/23` |
| 9 | Zhejiang Hairui Network Technology Co., Ltd. | 768 | 0.0048% | 3 | `60.191.140.0–60.191.140.255` in `60.191.140.0/23`<br>`60.191.141.0–60.191.141.255` in `60.191.140.0/23`<br>`115.238.228.0–115.238.228.255` in `115.238.228.0/24` |
| 10 | Hangzhou Network Technology Co., Ltd. Bank of Internet | 656 | 0.0041% | 6 | `115.236.73.128–115.236.73.255` in `115.236.72.0/22`<br>`122.224.103.128–122.224.103.255` in `122.224.100.0/22`<br>`122.224.128.112–122.224.128.127` in `122.224.128.0/22` |
| 11 | HangZhou Woodnn Technology Co., Ltd. | 640 | 0.0040% | 2 | `60.190.249.0–60.190.249.127` in `60.190.248.0/21`<br>`183.131.24.0–183.131.25.255` in `183.131.24.0/22` |
| 12 | Hangzhou Matrix Technology Co., Ltd. | 528 | 0.0033% | 29 | `122.225.96.0–122.225.96.15` in `122.225.96.0/23`<br>`122.225.96.16–122.225.96.31` in `122.225.96.0/23`<br>`122.225.96.32–122.225.96.47` in `122.225.96.0/23` |
| 13 | HangZhouSuLianXinXiKeJiYouXianGongSi Co.,ltd | 512 | 0.0032% | 2 | `183.131.68.0–183.131.68.255` in `183.131.68.0/22`<br>`183.131.69.0–183.131.69.255` in `183.131.68.0/22` |
| 14 | JinHuaXunChengXinXiChanYeFaZhanGongSi Co.,ltd | 512 | 0.0032% | 2 | `115.231.87.0–115.231.87.255` in `115.231.87.0/24`<br>`115.231.88.0–115.231.88.255` in `115.231.88.0/24` |
| 15 | Massive hangzhou network technology co., LTD | 512 | 0.0032% | 2 | `115.231.111.0–115.231.111.255` in `115.231.111.0/24`<br>`183.136.238.0–183.136.238.255` in `183.136.238.0/24` |
| 16 | Shanghai Great Wall Broadband Network Service Co., Ltd. | 512 | 0.0032% | 1 | `49.221.134.0–49.221.135.255` in `49.221.134.0/23` |
| 17 | Shaoxing Dingqi Network Technology Co., Ltd. | 512 | 0.0032% | 6 | `122.225.97.128–122.225.97.255` in `122.225.96.0/23`<br>`122.225.103.0–122.225.103.63` in `122.225.102.0/23`<br>`122.225.103.128–122.225.103.255` in `122.225.102.0/23` |
| 18 | Zhejiang province Telecom CO.,LTD Shaoxing Office | 512 | 0.0032% | 2 | `60.190.184.0–60.190.184.255` in `60.190.160.0/19`<br>`60.190.191.0–60.190.191.255` in `60.190.160.0/19` |
| 19 | ZHENGHAI TELECOM. CO.,LTD | 472 | 0.0030% | 11 | `61.153.148.144–61.153.148.159` in `61.153.144.0/21`<br>`61.153.148.160–61.153.148.191` in `61.153.144.0/21`<br>`115.238.130.208–115.238.130.223` in `115.238.130.0/23` |
| 20 | Jilin province high technology co., LTD | 412 | 0.0026% | 7 | `61.164.33.96–61.164.33.99` in `61.164.32.0/20`<br>`115.231.96.0–115.231.96.255` in `115.231.96.0/24`<br>`115.231.98.0–115.231.98.127` in `115.231.98.0/25` |
| 21 | Jiaxing Telecom Co.,LTD | 332 | 0.0021% | 13 | `60.190.129.196–60.190.129.199` in `60.190.128.0/22`<br>`60.190.131.64–60.190.131.79` in `60.190.128.0/22`<br>`60.190.136.32–60.190.136.39` in `60.190.136.0/23` |
| 22 | HANGZHOU SRT TECHNOLOGY CO., LTD | 320 | 0.0020% | 4 | `61.174.51.0–61.174.51.63` in `61.174.50.0/23`<br>`61.174.51.192–61.174.51.255` in `61.174.50.0/23`<br>`115.238.227.128–115.238.227.255` in `115.238.224.0/22` |
| 23 | Hangzhou Sulian Mdt InfoTech Ltd | 320 | 0.0020% | 2 | `61.153.106.0–61.153.106.63` in `61.153.106.0/24`<br>`115.231.23.0–115.231.23.255` in `115.231.23.0/24` |
| 24 | ZheJiang Province Telecom Co.,Ltd. | 320 | 0.0020% | 5 | `60.190.224.16–60.190.224.31` in `60.190.224.0/22`<br>`60.190.247.0–60.190.247.255` in `60.190.247.0/24`<br>`60.190.252.16–60.190.252.31` in `60.190.248.0/21` |
| 25 | Citic-kington Securities Co.,Ltd. | 296 | 0.0019% | 19 | `115.236.34.160–115.236.34.191` in `115.236.32.0/20`<br>`115.238.32.176–115.238.32.191` in `115.238.32.0/20`<br>`115.238.41.104–115.238.41.111` in `115.238.32.0/20` |
| 26 | Hangzhou Shell Star Tracker Network Technology Co., Ltd. | 288 | 0.0018% | 6 | `115.236.4.192–115.236.4.207` in `115.236.4.0/24`<br>`122.224.114.128–122.224.114.191` in `122.224.112.0/21`<br>`122.224.167.224–122.224.167.255` in `122.224.160.0/21` |
| 27 | Internet Banking Internet Technology Co., Ltd. Hangzhou | 288 | 0.0018% | 3 | `115.236.4.0–115.236.4.127` in `115.236.4.0/24`<br>`115.236.5.64–115.236.5.95` in `115.236.5.0/25`<br>`122.225.219.0–122.225.219.127` in `122.225.219.0/25` |
| 28 | ZheJiang Province Telecom Co.,LTD HangZhou City Filiale | 288 | 0.0018% | 3 | `60.190.226.240–60.190.226.255` in `60.190.224.0/22`<br>`61.164.45.208–61.164.45.223` in `61.164.32.0/20`<br>`61.164.55.0–61.164.55.255` in `61.164.48.0/21` |
| 29 | Zhejiang Telecom Company Limited Information Center | 288 | 0.0018% | 5 | `60.191.62.0–60.191.62.63` in `60.191.60.0/22`<br>`60.191.125.192–60.191.125.255` in `60.191.124.0/22`<br>`61.164.35.128–61.164.35.159` in `61.164.32.0/20` |
| 30 | HUACHEN NET LTD | 272 | 0.0017% | 3 | `122.227.45.16–122.227.45.23` in `122.227.44.0/22`<br>`122.227.45.32–122.227.45.39` in `122.227.44.0/22`<br>`183.131.67.0–183.131.67.255` in `183.131.67.0/24` |
| 31 | Jinhua City Meidiya Network Ltd. | 272 | 0.0017% | 2 | `115.239.195.0–115.239.195.255` in `115.239.192.0/22`<br>`122.226.222.48–122.226.222.63` in `122.226.222.0/24` |
| 32 | Ningbo Zhenhai Telecom Co.LTD | 264 | 0.0017% | 2 | `61.130.114.144–61.130.114.151` in `61.130.112.0/20`<br>`183.136.155.0–183.136.155.255` in `183.136.144.0/20` |
| 33 | Zhejiang Public Communication System Co.,Ltd. | 264 | 0.0017% | 2 | `60.191.115.0–60.191.115.255` in `60.191.112.0/21`<br>`122.225.221.24–122.225.221.31` in `122.225.220.0/22` |
| 34 | Fenghua YiSui Network Technology Co.,Ltd. | 256 | 0.0016% | 1 | `61.174.18.0–61.174.18.255` in `61.174.16.0/20` |
| 35 | Haining telecom Co.,ltd | 256 | 0.0016% | 1 | `60.190.155.0–60.190.155.255` in `60.190.155.0/24` |
| 36 | Haiou Network Technology Co., Ltd. | 256 | 0.0016% | 8 | `61.174.53.0–61.174.53.31` in `61.174.52.0/23`<br>`61.174.53.32–61.174.53.63` in `61.174.52.0/23`<br>`61.174.53.64–61.174.53.95` in `61.174.52.0/23` |
| 37 | Hangzhou Taobao Netwoks Co.,Ltd. | 256 | 0.0016% | 1 | `61.164.54.0–61.164.54.255` in `61.164.48.0/21` |
| 38 | Hangzhou Xiaoshan Information Co.,Ltd( Feilan Alliance of Network) | 256 | 0.0016% | 1 | `218.75.122.0–218.75.122.255` in `218.75.112.0/20` |
| 39 | Hangzhou century etang information technologies CO.,LTD | 256 | 0.0016% | 6 | `60.191.0.160–60.191.0.191` in `60.191.0.0/20`<br>`60.191.3.128–60.191.3.159` in `60.191.0.0/20`<br>`60.191.14.0–60.191.14.63` in `60.191.0.0/20` |
| 40 | Hangzhou treasure network co., LTD | 256 | 0.0016% | 1 | `183.131.13.0–183.131.13.255` in `183.131.13.0/24` |
| 41 | Huzhou Mobile Communications Co.,Ltd.(HUMCC) | 256 | 0.0016% | 1 | `211.140.116.0–211.140.116.255` in `211.140.0.0/17` |
| 42 | Jiaxingshi Xinda Dianzi Keji Co.,Ltd | 256 | 0.0016% | 1 | `183.134.49.0–183.134.49.255` in `183.134.49.0/24` |
| 43 | Jilin province high technology Co., Ltd. | 256 | 0.0016% | 1 | `183.131.18.0–183.131.18.255` in `183.131.18.0/24` |
| 44 | JinHua MeiDiYa Co.,ltd | 256 | 0.0016% | 1 | `61.153.99.0–61.153.99.255` in `61.153.99.0/24` |
| 45 | JinHuaShiMeiDiYaWangLuoKeJiYouXianGongSi Co.,ltd | 256 | 0.0016% | 1 | `183.146.212.0–183.146.212.255` in `183.146.212.0/24` |
| 46 | Linan Tianjian Computer Network Co., Ltd. | 256 | 0.0016% | 1 | `60.191.138.0–60.191.138.255` in `60.191.138.0/23` |
| 47 | QuZhou Mobile Communications Co.,Ltd.(QZMCC) | 256 | 0.0016% | 1 | `211.140.158.0–211.140.158.255` in `211.140.128.0/18` |
| 48 | ShaoXing mobile communication, Ltd. | 256 | 0.0016% | 1 | `211.140.133.0–211.140.133.255` in `211.140.128.0/18` |
| 49 | Transfer highway port logistics co., LTD | 256 | 0.0016% | 1 | `115.233.215.0–115.233.215.255` in `115.233.212.0/22` |
| 50 | Wenzhou Zhongbo Co.,ltd | 256 | 0.0016% | 1 | `61.164.121.0–61.164.121.255` in `61.164.120.0/23` |
| 51 | Zhejiang Public Communication System  Co.,Ltd. | 256 | 0.0016% | 1 | `60.191.114.0–60.191.114.255` in `60.191.112.0/21` |
| 52 | Zhejiang Radio And TV New Media Co.,Ltd | 256 | 0.0016% | 1 | `115.233.200.0–115.233.200.255` in `115.233.200.0/23` |
| 53 | Zhejiang rock Information Technology Co., Ltd. | 256 | 0.0016% | 1 | `122.224.234.0–122.224.234.255` in `122.224.232.0/21` |
| 54 | Zhejiang seized Road Network Technology Co., Ltd. | 256 | 0.0016% | 1 | `122.224.70.0–122.224.70.255` in `122.224.70.0/23` |
| 55 | ZheJiang Province Telecom Co.,Ltd. HangZhou City Filiale | 248 | 0.0016% | 7 | `60.191.54.216–60.191.54.223` in `60.191.48.0/21`<br>`122.224.108.128–122.224.108.255` in `122.224.108.0/22`<br>`122.224.109.0–122.224.109.31` in `122.224.108.0/22` |
| 56 | Xiaoshan Info Co.,Ltd. | 228 | 0.0014% | 4 | `60.191.41.32–60.191.41.63` in `60.191.40.0/23`<br>`60.191.41.64–60.191.41.127` in `60.191.40.0/23`<br>`61.175.193.220–61.175.193.223` in `61.175.192.0/20` |
| 57 | Fenghua Tuosu Co.,ltd | 224 | 0.0014% | 7 | `122.227.135.32–122.227.135.63` in `122.227.128.0/20`<br>`122.227.135.64–122.227.135.95` in `122.227.128.0/20`<br>`122.227.135.96–122.227.135.127` in `122.227.128.0/20` |
| 58 | Jinhua Meidiya Netware Science Co.,ltd | 216 | 0.0014% | 7 | `122.226.62.0–122.226.62.63` in `122.226.60.0/22`<br>`122.226.75.0–122.226.75.63` in `122.226.75.0/24`<br>`122.226.246.176–122.226.246.191` in `122.226.244.0/22` |
| 59 | Hangzhou eastern communications limited company,Hangzhou, Zhejiang Province | 208 | 0.0013% | 3 | `61.175.197.32–61.175.197.47` in `61.175.192.0/20`<br>`115.238.37.0–115.238.37.127` in `115.238.32.0/20`<br>`115.238.37.128–115.238.37.191` in `115.238.32.0/20` |
| 60 | Hempel (China) Co., Ltd. | 200 | 0.0013% | 12 | `115.236.5.224–115.236.5.239` in `115.236.5.192/26`<br>`115.236.17.144–115.236.17.159` in `115.236.17.0/24`<br>`115.236.17.160–115.236.17.175` in `115.236.17.0/24` |
| 61 | Jinhua Telecom Co.,ltd | 196 | 0.0012% | 44 | `60.191.198.64–60.191.198.67` in `60.191.198.0/23`<br>`60.191.210.16–60.191.210.19` in `60.191.208.0/21`<br>`60.191.210.228–60.191.210.231` in `60.191.208.0/21` |
| 62 | Ningbo Bitian science and Technology Co., Ltd. | 192 | 0.0012% | 2 | `183.136.146.0–183.136.146.63` in `183.136.144.0/20`<br>`183.136.150.128–183.136.150.255` in `183.136.144.0/20` |
| 63 | Ningbo Gaoxin Qianxin Network Information Co.,Ltd. | 192 | 0.0012% | 4 | `61.130.111.128–61.130.111.191` in `61.130.108.0/22`<br>`61.130.111.192–61.130.111.255` in `61.130.108.0/22`<br>`115.238.139.128–115.238.139.159` in `115.238.139.0/24` |
| 64 | Wenzhou Gaojie Co.,ltd | 192 | 0.0012% | 3 | `60.190.81.128–60.190.81.159` in `60.190.80.0/21`<br>`60.190.81.160–60.190.81.191` in `60.190.80.0/21`<br>`60.190.113.0–60.190.113.127` in `60.190.113.0/24` |
| 65 | Ningbo hi-tech park bi tian technology Co., LTD | 160 | 0.0010% | 2 | `183.136.156.128–183.136.156.255` in `183.136.144.0/20`<br>`183.136.192.0–183.136.192.31` in `183.136.192.0/21` |
| 66 | Ningbo Public Information Industry Co., Ltd. | 156 | 0.0010% | 5 | `61.130.106.168–61.130.106.171` in `61.130.106.0/23`<br>`61.130.106.172–61.130.106.175` in `61.130.106.0/23`<br>`61.130.106.248–61.130.106.251` in `61.130.106.0/23` |
| 67 | Hangzhou Yuesheng Electronic Dommunications Co.,Ltd | 152 | 0.0010% | 3 | `122.227.145.200–122.227.145.207` in `122.227.144.0/23`<br>`122.227.173.80–122.227.173.95` in `122.227.168.0/21`<br>`122.227.184.0–122.227.184.127` in `122.227.184.0/24` |
| 68 | Ningbo Shengshi Network Technology Co., Ltd | 144 | 0.0009% | 2 | `122.227.182.128–122.227.182.143` in `122.227.182.128/25`<br>`183.136.156.0–183.136.156.127` in `183.136.144.0/20` |
| 69 | Ningbo obang Information Technology Co., Ltd.TWO | 144 | 0.0009% | 5 | `122.226.168.0–122.226.168.31` in `122.226.168.0/21`<br>`122.226.168.32–122.226.168.63` in `122.226.168.0/21`<br>`122.226.171.128–122.226.171.159` in `122.226.168.0/21` |
| 70 | Shenzhen Century Triumph Technology Co., Ltd. | 144 | 0.0009% | 3 | `122.227.178.144–122.227.178.151` in `122.227.176.0/22`<br>`122.227.250.40–122.227.250.47` in `122.227.250.0/24`<br>`183.136.158.128–183.136.158.255` in `183.136.144.0/20` |
| 71 | ZheJiang taobao Co.,ltd | 144 | 0.0009% | 5 | `60.190.115.128–60.190.115.159` in `60.190.115.0/24`<br>`60.190.115.160–60.190.115.191` in `60.190.115.0/24`<br>`60.190.115.192–60.190.115.223` in `60.190.115.0/24` |
| 72 | Beijing Lanxun  Communications Technology Co.,Ltd | 140 | 0.0009% | 4 | `60.190.236.128–60.190.236.255` in `60.190.236.0/22`<br>`122.224.97.0–122.224.97.3` in `122.224.97.0/24`<br>`122.224.97.4–122.224.97.7` in `122.224.97.0/24` |
| 73 | Zhejiang Provice Telecom Limited Company Hangzhou Branch | 140 | 0.0009% | 13 | `60.190.240.240–60.190.240.243` in `60.190.240.0/24`<br>`60.191.74.252–60.191.74.255` in `60.191.72.0/21`<br>`60.191.88.96–60.191.88.127` in `60.191.88.0/22` |
| 74 | Zhejiang Telecom Co.,Ltd Hangzhou Branch | 140 | 0.0009% | 14 | `60.190.240.248–60.190.240.255` in `60.190.240.0/24`<br>`60.191.65.96–60.191.65.103` in `60.191.64.0/22`<br>`60.191.69.120–60.191.69.127` in `60.191.69.0/24` |
| 75 | Zhejiang Telecom Co.Ltd Hangzhou Limited | 136 | 0.0009% | 18 | `60.190.231.88–60.190.231.91` in `60.190.231.0/25`<br>`60.191.61.124–60.191.61.127` in `60.191.60.0/22`<br>`60.191.62.224–60.191.62.227` in `60.191.60.0/22` |
| 76 | Zhejiang Telecom Company Limited | 136 | 0.0009% | 4 | `60.190.236.120–60.190.236.127` in `60.190.236.0/22`<br>`60.191.43.192–60.191.43.255` in `60.191.43.128/25`<br>`60.191.78.0–60.191.78.31` in `60.191.72.0/21` |
| 77 | Ningbo Dianxin Co.,Ltd | 132 | 0.0008% | 32 | `60.190.19.12–60.190.19.15` in `60.190.16.0/21`<br>`60.190.23.148–60.190.23.151` in `60.190.16.0/21`<br>`60.190.30.240–60.190.30.243` in `60.190.30.0/24` |
| 78 | ZHEJIANG MOBILE COMMUNICATION CO.LTD | 132 | 0.0008% | 2 | `60.191.74.96–60.191.74.99` in `60.191.72.0/21`<br>`60.191.77.0–60.191.77.127` in `60.191.72.0/21` |
| 79 | Beijing Sohu Internet Message Server Co.,ltd | 128 | 0.0008% | 1 | `122.226.47.0–122.226.47.127` in `122.226.47.0/24` |
| 80 | Blue Communications Technology Co., Ltd. | 128 | 0.0008% | 2 | `61.153.151.128–61.153.151.191` in `61.153.144.0/21`<br>`122.227.245.64–122.227.245.127` in `122.227.244.0/22` |
| 81 | Ding Kai Shaoxing Network Technology Co., Ltd. | 128 | 0.0008% | 4 | `60.190.238.0–60.190.238.31` in `60.190.236.0/22`<br>`60.191.42.96–60.191.42.127` in `60.191.42.0/24`<br>`60.191.43.0–60.191.43.31` in `60.191.43.0/26` |
| 82 | FUYANG TELECOM CO.,LTD | 128 | 0.0008% | 1 | `202.107.193.0–202.107.193.127` in `202.107.193.0/24` |
| 83 | HANGZHOU DIFO TELECOMMUNICATION CO.LTD,Hangzhou,Zhejiang Province | 128 | 0.0008% | 1 | `202.101.184.128–202.101.184.255` in `202.101.176.0/20` |
| 84 | Hangzhou CLUDE Electric Information Technology Company Limited | 128 | 0.0008% | 4 | `60.190.144.0–60.190.144.31` in `60.190.144.0/24`<br>`60.190.144.32–60.190.144.63` in `60.190.144.0/24`<br>`60.190.144.64–60.190.144.95` in `60.190.144.0/24` |
| 85 | Hangzhou Woaiwojia real estate Co., Ltd. | 128 | 0.0008% | 32 | `60.190.226.136–60.190.226.139` in `60.190.224.0/22`<br>`60.190.239.188–60.190.239.191` in `60.190.236.0/22`<br>`60.191.54.128–60.191.54.131` in `60.191.48.0/21` |
| 86 | Hangzhou Yunshao Technology Co., Ltd. | 128 | 0.0008% | 1 | `183.131.16.0–183.131.16.127` in `183.131.16.0/23` |
| 87 | Jiaxing telecom Co.,LTD (IPTV Project) | 128 | 0.0008% | 1 | `122.225.0.0–122.225.0.127` in `122.225.0.0/21` |
| 88 | Shanghai Chen Yi-contact network Technology Co., Ltd. | 128 | 0.0008% | 1 | `122.224.115.0–122.224.115.127` in `122.224.112.0/21` |
| 89 | Shanghai Tuchu Computer Co.,Ltd. | 128 | 0.0008% | 1 | `115.238.166.128–115.238.166.255` in `115.238.166.0/23` |
| 90 | UTStarcom Telecom Co.,Ltd. | 128 | 0.0008% | 1 | `122.224.216.0–122.224.216.127` in `122.224.216.0/22` |
| 91 | ZHENGHAI OIL REFINING CHEMICAL CO.,LTD | 128 | 0.0008% | 1 | `218.0.4.0–218.0.4.127` in `218.0.0.0/19` |
| 92 | ZheJiang Province Telecom LTD LinAn City Branch | 128 | 0.0008% | 1 | `60.191.72.0–60.191.72.127` in `60.191.72.0/21` |
| 93 | ZheJiang Province Telecom LTD Xiaoshan Branch | 128 | 0.0008% | 1 | `60.191.121.128–60.191.121.255` in `60.191.120.0/23` |
| 94 | Zhejiang Electronic Port Co.,Ltd | 128 | 0.0008% | 7 | `60.191.76.80–60.191.76.95` in `60.191.72.0/21`<br>`60.191.126.168–60.191.126.175` in `60.191.124.0/22`<br>`115.236.37.128–115.236.37.159` in `115.236.32.0/20` |
| 95 | Zhejiang Securities Co., Ltd. | 128 | 0.0008% | 6 | `115.236.14.96–115.236.14.127` in `115.236.8.0/21`<br>`115.236.39.80–115.236.39.87` in `115.236.32.0/20`<br>`115.236.66.16–115.236.66.31` in `115.236.64.0/22` |
| 96 | Zhejiang Telecommunication Shaoxing Ltd | 128 | 0.0008% | 1 | `60.190.198.0–60.190.198.127` in `60.190.192.0/21` |
| 97 | Zhejiang commercial bank co. LTD | 128 | 0.0008% | 2 | `183.134.213.0–183.134.213.63` in `183.134.208.0/21`<br>`183.134.213.64–183.134.213.127` in `183.134.208.0/21` |
| 98 | cernrt network ltd. | 128 | 0.0008% | 1 | `122.224.127.128–122.224.127.255` in `122.224.124.0/22` |
| 99 | Zhejiang Telecom Company Limited Safety Dep. | 116 | 0.0007% | 15 | `60.190.231.0–60.190.231.7` in `60.190.231.0/25`<br>`60.190.231.8–60.190.231.15` in `60.190.231.0/25`<br>`60.190.231.16–60.190.231.23` in `60.190.231.0/25` |
| 100 | HANGZHOU UTSTAR Telecommunication Co.Ltd,Hangzhou,Zhejiang Province | 108 | 0.0007% | 4 | `60.191.4.64–60.191.4.127` in `60.191.0.0/20`<br>`61.175.193.128–61.175.193.159` in `61.175.192.0/20`<br>`61.175.199.224–61.175.199.227` in `61.175.192.0/20` |

其余 37,779 个较小登记主体标签未在 Markdown 展开，可在完整 gzip JSON 中查询。

## 其他登记：地址量前 100 项

共 52,979 个登记主体标签；下表展示前 100 项。标签优先取 APNIC organisation name，其次取 description、netname 或 organisation handle。
...
其余 52,879 个较小登记主体标签未在 Markdown 展开，可在完整 gzip JSON 中查询。
